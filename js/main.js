  ...
  // var wrapperGame = document.getElementById("wrapperGame");
  ...
  var deadline = 5; // tempo em segundo
  var pixelRatio;
  var mousePos;
  ...
  //
  //   var height = width;
  //   wrapperGame.style.width = width + "px";
  //   wrapperGame.style.height = height + "px";
  //   iconsBoomContainer.height = (iconsBoomContainer.clientHeight + iniheight) * pixelRatio;
  //   iconsBoomContainer.width = (iconsBoomContainer.clientWidth + iniWidth) * pixelRatio;
  // }
  ...
  function getRandomxPos() {
    return Math.floor((Math.random() * (iconsBoomContainer.height-iniheight)) + 1);
  }

  function getRandomyPos() {
    return Math.floor((Math.random() * (iconsBoomContainer.width-iniWidth)) + 1);
  }
  ...
  function getMousePos(canvas, event) {
    var rect = iconsBoomContainer.getBoundingClientRect();
  ...
  iconsBoomContainer.addEventListener('mousemove',function(event){
    mousePos = getMousePos(iconsBoomContainer, event);
    mouseX = mousePos.x;
    mouseY = mousePos.y;
  })
  iconsBoomContainer.addEventListener('click', function() {
    icons.map(function(icon, index) {
